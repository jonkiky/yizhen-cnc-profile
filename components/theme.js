...
export const Paper = tw.div`mx-auto`;
export const Container = tw.div`w-full mx-auto  items-center justify-between mt-0 px-6 py-3 leading-10`;
...
export const Section = tw.section`md:h-screen flex md:flex-row  flex-col md:grid md:grid-cols-2  md:gap-4 my-auto content-center`;
