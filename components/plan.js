...
function Plan() {
  ...
  return (
   <section id="plan" className="w-full z-30 top-0 pt-96 pb-96 bg-[url('/assets/images/plan.png')] bg-cover ">
        <div className="w-full container mx-auto flex text-center flex-wrap items-center justify-between mt-0 px-6 py-3">
             <h1 className="w-full py-4 px-4 text-7xl font-extrabold bg-slate-50 opacity-90">看营养师是怎么设计Plan的</h1>
