            	...
            	<div className="col-span-2">
            		...
            		<div class="content flex-none  lg:flex">
            				...
            				<div className="item-body px-2 ">
			            		...
			            		Star with why and stay with why. 
			         			当有了明确的目标，才能正确的定义How。
								</Paragraph>
								...
								TO_____ So that___  <br/>
								我需要做什么，可以让我得到什么。<br/>
								</Paragraph>

								<Paragraph >
								大多数人行为模型是从做什么到怎么做开始，没有或者过于肤浅的定义了目标。<br/> 
								比如很多人开始减肥，简单的将目标定义为减重10斤为目标，
								这里的确有了目标，但是这目标却太过于平常，并无法提供太多动力。<br/>
								</Paragraph>
	            ...
	            <div className="col-span-2">
			            ...
			            <Paragraph>
			            	减肥一般有减瘦再增肥的流程。这比较痛苦，会使肌肉流失，新陈代谢下降，而且大多数人很难成功，所以我推荐尝试减脂不减肌肉。 
  							<br/>
  							饮食计划就偏高蛋白，低碳水和脂肪，同时注意肝肾功能（C罗就是采用高蛋白质的饮食）。<br/>
             			</Paragraph>
             			...
             			<Paragraph>
             			最喜欢做饮食计划，<UnderLine>好的饮食计划能确保你的减肥效果，精确到克。确保你能相信这个减肥计划是可行的</UnderLine>。
						...
						<span className="text-slate-900">例如基础代谢为2935 calories/ day(活动因子1.5）, 如果我们按 2 pounds per week计算。</span> <br/>
						 <br/>
						...
						<br/>
						每周要减 907克（2 pounds = 907.185 grams ），需要能量赤字 907grams * 7.7 calories/gram= 6984 calories <br/>
						每天就的能量赤字就是 6984 / 7 = 998 calories <br/>
						我们每天需要的能量为：2935-998 = 1937 calories/ day <br/>
						</Paragraph>
						...
						脂肪: 54g<br/>
             			...
             			<Paragraph>
							1. 增加背，肩，腿部的绝对力量输出。身体的维度中减肥期间会降低，增肌会增加身体围度。
							通过围度来测量肌肉增长并不准确。通过测试力量的绝对输出值能更直观看到锻炼的效果。
							例如卧推100kg 到150kg。  <br/>
							2. 增加平衡锻炼项目。<br/>
             			</Paragraph>
	            ...
	            <div className="col-span-2">
			            ...
			            <Paragraph>
             			...
             			<Paragraph>
			            	...
			            	比如四菜一汤，但是减肥的话。我们需要每个人吃定量的饭菜，就得每人吃一盘。
			            	四菜一汤合着吃很难判断出，一个人吃了多少。
			            	<br/>
			            	需要注意喝水量
             			</Paragraph>
             			<Paragraph>
            ...
            <section className=" flex flex-row grid grid-cols-3  gap-4 my-48 content-center">
	            <Title>我自己的方案</Title>
	            					...
	            					<SubTitle>目标</SubTitle>
										<Paragraph>
										我希望有接近Rory McIlroy身体条件来支持我打出更漂亮的高尔夫。 
										</Paragraph>
										<Paragraph>
									...
									<SubTitle>减脂计划</SubTitle>
										...
										<Paragraph>
											...
											周五节食24小时，只吃晚上，给肠胃放假，其次锻炼大脑对身体的控制。
										</Paragraph>
